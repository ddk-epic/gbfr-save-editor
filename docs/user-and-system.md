...
SystemData and the start of SlotData hold the account-wide state: save versions, the play timer, the current stage, the player name, currencies and a few unnamed counters and flag sets. Every IDType here has a single unit at UnitID 0.

## SystemData

SystemData uses IDTypes 801-841 and has no version field.
...
User data uses IDTypes 1101-1151.
...
Location uses IDTypes 1201-1207.
