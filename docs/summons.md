...
Summons occupy 1000 UnitIDs, `UNIT.SUMMON` (0) to 999. Every save has all 1000 units, a new game included. A summon id of 0 marks an empty entry.
...
The summon list shares its IDType range with these units:

| IDType | UnitIDs | Name               | Type      | Holds                                                                                               |
| ------ | ------- | ------------------ | --------- | --------------------------------------------------------------------------------------------------- |
